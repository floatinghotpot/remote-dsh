...
[English](../en/01-lan-access.md) | **中文**
...
| 场景 | 方案 | 说明 |
|---|---|---|
| 智能体**部署在云服务器**（阿里云 ECS 等） | **M2 云服务器直连** | HTTPS + 用户名/密码 + systemd 常驻，公网直接访问（[云服务器部署系列 ②/③/④](../zh/02-cloud-single-tls.md)） |
| 智能体**在家里的开发机**（无公网 IP），出差在外想访问 | **M3 hub 隧道** | 智能体只**出站**连接 hub，不暴露任何端口（[⑤ 公网 hub 篇](../zh/05-hub-public.md)） |
