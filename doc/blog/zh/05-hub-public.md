# 多台机器，一个网址：用 rdsh hub 从公网统一遥控你所有的 DSH 智能体

[English](../en/05-hub-public.md) | **中文**
...
| 方案 | 适用 | 说明 |
|---|---|---|
| [① 局域网遥控](../zh/01-lan-access.md) | 单台机器、同一 WiFi | `rdsh serve` 配对码 |
| [②③④ 云服务器直连](../zh/02-cloud-single-tls.md) | 单台、有公网 IP 的机器 | `rdsh serve` + HTTPS/反代 |
