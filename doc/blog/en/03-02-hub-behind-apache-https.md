...
- **Tested**: `behindProxy` (plain-http + XFF rate limiting) implemented and verified 2026-08-23; the Apache2 setup mirrors [02-02 Apache2 post](../en/02-02-cloud-apache-acme.md)
