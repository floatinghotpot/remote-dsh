...
> **状态**: M1–M5 已完成并发布；**SaaS 商业化（08-saas）进行中**（注册/订阅/支付，实现进度与商业细节见私有文档）；M8/M9 降级为品牌/营销渠道
...
| 里程碑 | 内容 | 状态 |
|---|---|---|
| **M6 SaaS 上线准备** | 隐私政策/部署文档/压测 + 资质 | ⏳ 进行中（资质核验与文档推进中，细节见私有文档） |
| **SaaS 托管轨 S1–S4** | 商业化托管 hub：注册/试用/配额/订阅/支付 | ⏳ 进行中（实现进度与商业细节见私有文档） |
| **09 云端 DSH / 10 Token 转售** | 未来商业方向 | 💡 讨论中（详见私有文档） |
...
- **相关决策**：Q3（小程序后置）
- **定位（2026-08-26）**：**非用户必需**（微信内浏览器打开 hub 链接已验证可用）—— 定位**品牌/营销渠道**（微信生态入口、免安装、分享传播）；后置、按需启动

## SaaS 里程碑详情

### M6 SaaS 上线准备 ⏳

- **内容**：隐私政策 / 用户协议 / 数据删除、部署文档、压测（含 300 MB 大流量压测，M1 遗留项）；资质核验（经营性 ICP / 备案等，细节见私有文档）
- **验收**：达到公开服务标准

### SaaS 托管轨（S1–S4）⏳

> 商业化托管 hub：注册 / 试用 / 配额 / 订阅 / 支付。实现进度、支付渠道、资质与商业细节见**私有文档**（`private/doc/feature/08-saas/`）。

### 09 云端 DSH / 10 Token 转售 💡

> 未来商业方向，讨论中。详情见**私有文档**（`private/doc/feature/09-saas-cloud-dsh/`、`10-saas-dsh-token/`）。

## 当前焦点

1. **M1–M5 已完成并发布**（2026-08-24）
2. **SaaS 商业化（08-saas）**：进行中（详情见私有文档）
...
| 2026-08-26 | **SaaS 商业化定案**：支付选型、S1–S4 拆分、资质核验、09/10 立项、M7 延后——细节见私有文档 |
