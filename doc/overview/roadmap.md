...
| **09 云端 DSH / 10 Token 转售** | 未来商业方向：云主机 + DSH 预装；模型额度转售 | 💡 讨论中（详见私有文档） |
...
- **S4 反滥用·安全·运营** ⏳ 进行中（验证码 / 限流 / 防轰炸 / 审计已落地；端到端加密为并行 P0）
- 实现进度、支付渠道、资质与商业细节见**私有文档**。

### 09 云端 DSH / 10 Token 转售 💡

> 未来商业方向（08-saas 之后），讨论中：**09 云端 DSH**（云主机 + DSH 预装，用户自带 key）；**10 Token 转售**（模型额度）。详情见私有文档。
