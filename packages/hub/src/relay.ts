...
export const BACK_BAR_HTML = `<a href="/portal/hosts" style="position:fixed;top:90px;right:20px;z-index:99999;background:rgba(30,30,30,.88);color:#e2e8f0;padding:6px 14px;border-radius:16px;border:1px solid rgba(255,255,255,.4);text-decoration:none;font:13px system-ui,sans-serif;box-shadow:0 2px 8px rgba(0,0,0,.3);">← 返回</a>`;
